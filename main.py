# main.py - Contra RL avec architecture modulaire propre
"""
...
Progression:
  REWARD_PROGRESS = +8.0      Vraie progression (8x augmenté!)
  REWARD_BACKWARD = -0.5      Reculer
  REWARD_IDLE = -0.1          Inactivité

Combat:
  REWARD_SHOOT = 0            Tir neutre
  REWARD_ENEMY_HIT = +75      Tuer ennemi
  REWARD_WASTED_BULLET = -3   Tir inutile
  REWARD_DAMAGE = -30         Prendre dégât

Fin de partie:
  REWARD_DEATH = -50          Mort/chute fossé
  REWARD_GOAL = +1200         Atteindre flag
  REWARD_LIFE_BONUS = +50     Bonus par vie
